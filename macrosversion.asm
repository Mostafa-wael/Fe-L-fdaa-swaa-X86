...
MAIN PROC FAR
	...
	CHECK:     mov  ah,1
			   ...
			   ;	IF THE USER PRESS KEY: GENERATE THE OFFSET THAT GENERATED BY THIS KEY

			   CALL GENERATE_OFFSET			; TO GENERATE THE OFFSET OF THE PADDLE
...
GENERATE_OFFSET PROC		; THIS PROCEDURE GENERATES 
